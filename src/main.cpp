...
#include "../lib/imgui_extensions/ImguiDirectoryTreeView.h"
...
int main(int, char**)
{
  ...
  while (!glfwWindowShouldClose(window))
  {
    ...
    // Interface
    if(directory_renderer.selected != -1 && strcmp(img, directory_renderer.getSelected()) != 0){
      strcpy(img, directory_renderer.getSelected());
      ret = LoadTextureFromFile(img, &my_image_texture, &my_image_width, &my_image_height);
      IM_ASSERT(ret);
    }

    static bool winOpen = true;
    ImGui::Begin("Debug##Default", &winOpen, ImGuiWindowFlags_DockNodeHost | ImGuiWindowFlags_AlwaysAutoResize);
    ImGui::End();
